...
namespace ParkEFI.Infrastructure.Migrations
{
    ...
    [Migration("20211013043347_Create tables, Companies, Coordinates, Garages, ParkingBase, Parkings, Streets")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkEFI.Domain.Entities.CityEntity", b =>
                {
                    ...
                    b.Property<DateTime>("DateRegister")
                        ...
                        .HasDefaultValue(new DateTime(2021, 10, 13, 0, 33, 47, 328, DateTimeKind.Local).AddTicks(592));
            ...
            modelBuilder.Entity("ParkEFI.Domain.Entities.CompanyEntity", b =>
                {
                    ...
                    b.Property<DateTime>("DateRegister")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 13, 0, 33, 47, 338, DateTimeKind.Local).AddTicks(8362));
            ...
            modelBuilder.Entity("ParkEFI.Domain.Entities.CountryEntity", b =>
                {
                    ...
                    b.Property<DateTime>("DateRegister")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 13, 0, 33, 47, 346, DateTimeKind.Local).AddTicks(9660));
            ...
            modelBuilder.Entity("ParkEFI.Domain.Entities.ParkingBaseEntity", b =>
                {
                    ...
                    b.Property<DateTime>("DateRegister")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 13, 0, 33, 47, 355, DateTimeKind.Local).AddTicks(1156));
            ...
            modelBuilder.Entity("ParkEFI.Domain.Entities.PersonEntity", b =>
                {
                    ...
                    b.Property<DateTime>("DateRegister")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 13, 0, 33, 47, 385, DateTimeKind.Local).AddTicks(4352));
            ...
            modelBuilder.Entity("ParkEFI.Domain.Entities.ProvinceEntity", b =>
                {
                    ...
                    b.Property<DateTime>("DateRegister")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 13, 0, 33, 47, 388, DateTimeKind.Local).AddTicks(3040));
            ...
            modelBuilder.Entity("ParkEFI.Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("DateRegister")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 13, 0, 33, 47, 390, DateTimeKind.Local).AddTicks(417));
            ...
            modelBuilder.Entity("ParkEFI.Domain.Entities.ParkingEntity", b =>
                {
                    b.HasOne("ParkEFI.Domain.Entities.CompanyEntity", null)
                        .WithMany("Parkings")
